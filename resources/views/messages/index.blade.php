...
<div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
    <div>
        ...
        <h1 class="admin-page-title mt-2">Messages</h1>
        <p class="admin-page-subtitle">Send communications via Email, SMS, Beep Call, or Social Media</p>
    </div>
    <a href="{{ route('events.messages.create', $event) }}" class="admin-btn-primary">
        Create message
    </a>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="space-x-2 text-right">
                    ...
                    @endif
                    <a href="{{ route('events.messages.edit', [$event, $message]) }}" class="admin-link">Edit</a>
            ...
            <tr>
                <td colspan="5" class="py-12 text-center text-ink/50">
                    No messages yet. <a href="{{ route('events.messages.create', $event) }}" class="admin-link">Create your first message</a>
                </td>
            </tr>
            @endforelse
        </tbody>
